...
void exposeResidualCentroidalAngularMomentum() {
  ...
  bp::register_ptr_to_python<boost::shared_ptr<ResidualModelCentroidalAngularMomentum> >();

  bp::class_<ResidualModelCentroidalAngularMomentum, bp::bases<ResidualModelAbstract> >(
      "ResidualModelCentroidalAngularMomentum",
      "This residual function defines the centroidal momentum tracking as r = h - href, with h and href as the\n"
      "current and reference centroidal momenta, respectively.",
      bp::init<boost::shared_ptr<StateKinodynamic>, Vector6d, std::size_t>(
          bp::args("self", "state", "href", "nu"),
          "Initialize the centroidal momentum residual model.\n\n"
          ":param state: state of the multibody system\n"
          ":param href: reference centroidal momentum\n"
          ":param nu: dimension of control vector"))
      .def(bp::init<boost::shared_ptr<StateKinodynamic>, std::size_t>(
          bp::args("self", "state", "href"),
          "Initialize the centroidal momentum residual model.\n\n"
          "The default nu is obtained from state.nv.\n"
          ":param state: state of the multibody system\n"
         ":param nu: dimension of control vector"))
      .def<void (ResidualModelCentroidalAngularMomentum::*)(const boost::shared_ptr<ResidualDataAbstract>&,
                                                     const Eigen::Ref<const Eigen::VectorXd>&,
                                                     const Eigen::Ref<const Eigen::VectorXd>&)>(
          "calc", &ResidualModelCentroidalAngularMomentum::calc, bp::args("self", "data", "x", "u"),
          "Compute the centroidal momentum residual.\n\n"
          ":param data: residual data\n"
          ":param x: state point (dim. state.nx)\n"
          ":param u: control input (dim. nu)")
      ...
      .def<void (ResidualModelCentroidalAngularMomentum::*)(const boost::shared_ptr<ResidualDataAbstract>&,
                                                     const Eigen::Ref<const Eigen::VectorXd>&,
                                                     const Eigen::Ref<const Eigen::VectorXd>&)>(
          "calcDiff", &ResidualModelCentroidalAngularMomentum::calcDiff, bp::args("self", "data", "x", "u"),
          "Compute the Jacobians of the centroidal momentum residual.\n\n"
          "It assumes that calc has been run first.\n"
          ":param data: action data\n"
          ":param x: state point (dim. state.nx)\n"
      ...
      .def<void (ResidualModelCentroidalAngularMomentum::*)(const boost::shared_ptr<ResidualDataAbstract>&,
                                                     const Eigen::Ref<const Eigen::VectorXd>&)>(
          "calcDiff", &ResidualModelAbstract::calcDiff, bp::args("self", "data", "x"))
      .def("createData", &ResidualModelCentroidalAngularMomentum::createData, bp::with_custodian_and_ward_postcall<0, 2>(),
           bp::args("self", "data"),
           "Create the centroidal momentum residual data.\n\n"
           "Each residual model has its own data that needs to be allocated. This function\n"
           "returns the allocated data for the centroidal momentum residual.\n"
      ...
      .add_property(
          "reference",
          bp::make_function(&ResidualModelCentroidalAngularMomentum::get_reference, bp::return_internal_reference<>()),
          &ResidualModelCentroidalAngularMomentum::set_reference, "reference centroidal momentum");

  bp::register_ptr_to_python<boost::shared_ptr<ResidualDataCentroidalAngularMomentum> >();

  bp::class_<ResidualDataCentroidalAngularMomentum, bp::bases<ResidualDataAbstract> >(
      "ResidualDataCentroidalAngularMomentum", "Data for centroidal momentum residual.\n\n",
      bp::init<ResidualModelCentroidalAngularMomentum*, DataCollectorAbstract*>(
          bp::args("self", "model", "data"),
          "Create centroidal momentum residual data.\n\n"
          ":param model: centroidal momentum residual model\n"
          ":param data: shared data")[bp::with_custodian_and_ward<1, 2, bp::with_custodian_and_ward<1, 3> >()])
      .add_property("pinocchio",
                    bp::make_getter(&ResidualDataCentroidalAngularMomentum::pinocchio, bp::return_internal_reference<>()),
                    "pinocchio data")
      .add_property("dhd_dq",
                    bp::make_getter(&ResidualDataCentroidalAngularMomentum::dhd_dq, bp::return_internal_reference<>()),
                    "Jacobian of the centroidal momentum")
      .add_property("dhd_da",
                    bp::make_getter(&ResidualDataCentroidalAngularMomentum::dhd_da, bp::return_internal_reference<>()),
                    "Jacobian of the centroidal momentum");
}
