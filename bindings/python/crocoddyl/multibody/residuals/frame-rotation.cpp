...
void exposeResidualKinoFrameRotation() {
  bp::register_ptr_to_python<boost::shared_ptr<ResidualKinoFrameRotation> >();

  bp::class_<ResidualKinoFrameRotation, bp::bases<ResidualModelAbstract> >(
      "ResidualKinoFrameRotation",
      "This residual function is defined as r = R - Rref, with R and Rref as the current and reference\n"
      "frame rotations, respectively.",
      bp::init<boost::shared_ptr<StateKinodynamic>, pinocchio::FrameIndex, Eigen::Matrix3d, std::size_t>(
          bp::args("self", "state", "id", "Rref", "nu"),
          "Initialize the frame rotation residual model.\n\n"
          ":param state: state of the multibody system\n"
          ":param id: reference frame id\n"
          ":param Rref: reference frame rotation\n"
          ":param nu: dimension of control vector"))
      .def(bp::init<boost::shared_ptr<StateKinodynamic>, pinocchio::FrameIndex, Eigen::Matrix3d>(
          bp::args("self", "state", "id", "Rref"),
          "Initialize the frame rotation residual model.\n\n"
          "The default nu value is obtained from model.nv.\n"
          ":param state: state of the multibody system\n"
          ":param id: reference frame id\n"
          ":param Rref: reference frame rotation"))
      .def<void (ResidualKinoFrameRotation::*)(const boost::shared_ptr<ResidualDataAbstract>&,
                                                const Eigen::Ref<const Eigen::VectorXd>&,
                                                const Eigen::Ref<const Eigen::VectorXd>&)>(
          "calc", &ResidualKinoFrameRotation::calc, bp::args("self", "data", "x", "u"),
          "Compute the frame rotation residual.\n\n"
          ":param data: residual data\n"
          ":param x: state point (dim. state.nx)\n"
          ":param u: control input (dim. nu)")
      ...
      .def<void (ResidualKinoFrameRotation::*)(const boost::shared_ptr<ResidualDataAbstract>&,
                                                const Eigen::Ref<const Eigen::VectorXd>&,
                                                const Eigen::Ref<const Eigen::VectorXd>&)>(
          "calcDiff", &ResidualKinoFrameRotation::calcDiff, bp::args("self", "data", "x", "u"),
          "Compute the Jacobians of the frame rotation residual.\n\n"
          "It assumes that calc has been run first.\n"
          ":param data: action data\n"
          ":param x: state point (dim. state.nx)\n"
      ...
      .def<void (ResidualKinoFrameRotation::*)(const boost::shared_ptr<ResidualDataAbstract>&,
                                                const Eigen::Ref<const Eigen::VectorXd>&)>(
          "calcDiff", &ResidualModelAbstract::calcDiff, bp::args("self", "data", "x"))
      .def("createData", &ResidualKinoFrameRotation::createData, bp::with_custodian_and_ward_postcall<0, 2>(),
           bp::args("self", "data"),
           "Create the frame rotation residual data.\n\n"
           "Each residual model has its own data that needs to be allocated. This function\n"
           "returns the allocated data for the frame rotation residual.\n"
           ":param data: shared data\n"
           ":return residual data.")
      .add_property("id", &ResidualKinoFrameRotation::get_id, &ResidualKinoFrameRotation::set_id,
                    "reference frame id")
      .add_property("reference",
                    bp::make_function(&ResidualKinoFrameRotation::get_reference, bp::return_internal_reference<>()),
                    &ResidualKinoFrameRotation::set_reference, "reference frame rotation");
    /*
    bp::register_ptr_to_python<boost::shared_ptr<ResidualDataFrameRotation> >();

    bp::class_<ResidualDataFrameRotation, bp::bases<ResidualDataAbstract> >(
        "ResidualDataFrameRotation", "Data for frame rotation residual.\n\n",
        bp::init<ResidualKinoFrameRotation*, DataCollectorAbstract*>(
            bp::args("self", "model", "data"),
            "Create frame rotation residual data.\n\n"
            ":param model: frame rotation residual model\n"
            ":param data: shared data")[bp::with_custodian_and_ward<1, 2, bp::with_custodian_and_ward<1, 3> >()])
