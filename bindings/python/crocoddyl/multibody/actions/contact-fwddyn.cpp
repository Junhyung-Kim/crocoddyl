...
void exposeDifferentialActionKinoDynamics() {
  bp::register_ptr_to_python<boost::shared_ptr<DifferentialActionModelKinoDynamics> >();

  bp::class_<DifferentialActionModelKinoDynamics, bp::bases<DifferentialActionModelAbstract> >(
      "DifferentialActionModelKinoDynamics",
      ...
      .def<void (DifferentialActionModelKinoDynamics::*)(
          const boost::shared_ptr<DifferentialActionDataAbstract>&, const Eigen::Ref<const Eigen::VectorXd>&,
          const Eigen::Ref<const Eigen::VectorXd>&)>(
          "calcDiff", &DifferentialActionModelKinoDynamics::calcDiff, bp::args("self", "data", "x", "u"),
      ...
      .def("createData", &DifferentialActionModelKinoDynamics::createData, bp::args("self"),
           "Create the contact forward dynamics differential action data.")
      .add_property("pinocchio",
                    bp::make_function(&DifferentialActionModelKinoDynamics::get_pinocchio,
                                      bp::return_internal_reference<>()),
                    "multibody model (i.e. pinocchio model)")
      .add_property("actuation",
                    bp::make_function(&DifferentialActionModelKinoDynamics::get_actuation,
                                      bp::return_value_policy<bp::return_by_value>()),
                    "actuation model")
      .add_property("costs",
                    bp::make_function(&DifferentialActionModelKinoDynamics::get_costs,
                                      bp::return_value_policy<bp::return_by_value>()),
                    "total cost model")
      .add_property("armature",
                    bp::make_function(&DifferentialActionModelKinoDynamics::get_armature,
                                      bp::return_value_policy<bp::return_by_value>()),
                    bp::make_function(&DifferentialActionModelKinoDynamics::set_armature),
                    "set an armature mechanism in the joints");

  bp::register_ptr_to_python<boost::shared_ptr<DifferentialActionDataKinoDynamics> >();

  bp::class_<DifferentialActionDataKinoDynamics, bp::bases<DifferentialActionDataAbstract> >(
      "DifferentialActionDataKinoDynamics", "Action data for the contact forward dynamics system.",
      bp::init<DifferentialActionModelKinoDynamics*>(bp::args("self", "model"),
                                                           "Create contact forward-dynamics action data.\n\n"
                                                           ":param model: contact forward-dynamics action model"))
      .add_property(
          "pinocchio",
          bp::make_getter(&DifferentialActionDataKinoDynamics::pinocchio, bp::return_internal_reference<>()),
          "pinocchio data")
      .add_property(
          "multibody",
          bp::make_getter(&DifferentialActionDataKinoDynamics::multibody, bp::return_internal_reference<>()),
          "multibody data")
      .add_property("costs",
                    bp::make_getter(&DifferentialActionDataKinoDynamics::costs,
                                    bp::return_value_policy<bp::return_by_value>()),
                    "total cost data");
}
