...
#ifndef CROCODDYL_MULTIBODY_RESIDUALS_KINOFRAME_PLACEMENT_HPP_
#define CROCODDYL_MULTIBODY_RESIDUALS_KINOFRAME_PLACEMENT_HPP_
...
/* --- Details -------------------------------------------------------------- */
/* --- Details -------------------------------------------------------------- */
#include "crocoddyl/multibody/residuals/kinoframe-placement.hxx"
