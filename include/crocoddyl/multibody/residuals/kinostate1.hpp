...
#ifndef CROCODDYL_MULTIBODY_RESIDUALS_KINOSTATE1_HPP_
#define CROCODDYL_MULTIBODY_RESIDUALS_KINOSTATE1_HPP_
...
namespace crocoddyl
{
  ...
  class ResidualFlyState1Tpl : public ResidualModelAbstractTpl<_Scalar>
  {
  public:
     ...
     */
    ResidualFlyState1Tpl(boost::shared_ptr<typename Base::StateAbstract> state, const VectorXs &xref,
                        const std::size_t nu);
     ...
     * @param[in] nu     Dimension of the control vector
     */
    ResidualFlyState1Tpl(boost::shared_ptr<typename Base::StateAbstract> state, const std::size_t nu);
     ...
     */
    ResidualFlyState1Tpl(boost::shared_ptr<typename Base::StateAbstract> state);
    virtual ~ResidualFlyState1Tpl();
...
/* --- Details -------------------------------------------------------------- */
/* --- Details -------------------------------------------------------------- */
#include "crocoddyl/multibody/residuals/kinostate1.hxx"
