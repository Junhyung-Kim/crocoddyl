...
#ifndef CROCODDYL_MULTIBODY_RESIDUALS_ANGULARMOMENTUM_HPP_
#define CROCODDYL_MULTIBODY_RESIDUALS_ANGULARMOMENTUM_HPP_
...
/* --- Details -------------------------------------------------------------- */
/* --- Details -------------------------------------------------------------- */
#include "crocoddyl/multibody/residuals/centroidal-angular-momentum.hxx"
