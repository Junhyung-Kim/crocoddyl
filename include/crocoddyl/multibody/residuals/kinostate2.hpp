...
#ifndef CROCODDYL_MULTIBODY_RESIDUALS_KINOSTATE2_HPP_
#define CROCODDYL_MULTIBODY_RESIDUALS_KINOSTATE2_HPP_
...
namespace crocoddyl
{
  ...
  class ResidualFlyState2Tpl : public ResidualModelAbstractTpl<_Scalar>
  {
  public:
     ...
     */
    ResidualFlyState2Tpl(boost::shared_ptr<typename Base::StateAbstract> state, const VectorXs &xref,
                        const std::size_t nu);
     ...
     * @param[in] nu     Dimension of the control vector
     */
    ResidualFlyState2Tpl(boost::shared_ptr<typename Base::StateAbstract> state, const std::size_t nu);
     ...
     */
    ResidualFlyState2Tpl(boost::shared_ptr<typename Base::StateAbstract> state);
    virtual ~ResidualFlyState2Tpl();
...
/* --- Details -------------------------------------------------------------- */
/* --- Details -------------------------------------------------------------- */
#include "crocoddyl/multibody/residuals/kinostate2.hxx"
