...
namespace crocoddyl
{
  ...
  ResidualFlyState1Tpl<Scalar>::ResidualFlyState1Tpl(boost::shared_ptr<typename Base::StateAbstract> state,
      ...
      : Base(state, /*2,*/ 6, nu, false, false, false, false, false, false, true), xref_(xref)
  {
  ...
  ResidualFlyState1Tpl<Scalar>::ResidualFlyState1Tpl(boost::shared_ptr<typename Base::StateAbstract> state,
                                                   const VectorXs &xref)
      : Base(state, /*2,*/ 6, false, false, false, false, false, false, true), xref_(xref)
  {
    if (static_cast<std::size_t>(xref_.size()) != state_->get_nx() + 8)
    {
      throw_pretty("Invalid argument: "
  ...
  ResidualFlyState1Tpl<Scalar>::ResidualFlyState1Tpl(boost::shared_ptr<typename Base::StateAbstract> state,
                                                   const std::size_t nu)
      : Base(state, /*2,*/ 6, nu, false, false, false, false, false, false, true), xref_(state->zero()) {}

  template <typename Scalar>
  ResidualFlyState1Tpl<Scalar>::ResidualFlyState1Tpl(boost::shared_ptr<typename Base::StateAbstract> state)
      : Base(state, /*2,*/ 6, false, false, false, false, false, true), xref_(state->zero()) {}
                                         ...
                                         const Eigen::Ref<const VectorXs> &x, const Eigen::Ref<const VectorXs> &u)
  {
    ...
    data->r.tail(4).head(2) = x.head(23).tail(2) - xref_.head(2);//xref_(0);
    data->r.tail(2) = x.head(25).tail(2) + xref_.head(2);//xref_(0);
  }
                                             ...
                                             const Eigen::Ref<const VectorXs> &x, const Eigen::Ref<const VectorXs> &u)
  {
    ...
    data->Rx.bottomLeftCorner(6, 24).bottomRightCorner(6, 6).diagonal().array() = (Scalar)1;
  }
