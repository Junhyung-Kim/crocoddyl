...
#ifndef CROCODDYL_MULTIBODY_RESIDUALS_KINOFRAME_ROTATION_HPP_
#define CROCODDYL_MULTIBODY_RESIDUALS_KINOFRAME_ROTATION_HPP_
...
struct ResidualDataKinoFrameRotationTpl : public ResidualDataAbstractTpl<_Scalar> {
  ...
  ResidualDataKinoFrameRotationTpl(Model<Scalar>* const model, DataCollectorAbstract* const data)
...
template <typename _Scalar>
class ResidualKinoFrameRotationTpl : public ResidualModelAbstractTpl<_Scalar> {
 public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  typedef ResidualDataKinoFrameRotationTpl<Scalar> Data;
   ...
   */
  ResidualKinoFrameRotationTpl(boost::shared_ptr<StateKinodynamic> state, const pinocchio::FrameIndex id,
  ...
  ResidualKinoFrameRotationTpl(boost::shared_ptr<StateKinodynamic> state, const pinocchio::FrameIndex id,
                                const Matrix3s& Rref);
  virtual ~ResidualKinoFrameRotationTpl();
...
/* --- Details -------------------------------------------------------------- */
/* --- Details -------------------------------------------------------------- */
#include "crocoddyl/multibody/residuals/kinoframe-rotation.hxx"
