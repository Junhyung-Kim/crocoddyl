...
#ifndef CROCODDYL_MULTIBODY_RESIDUALS_KINOSTATE_HPP_
#define CROCODDYL_MULTIBODY_RESIDUALS_KINOSTATE_HPP_
...
/* --- Details -------------------------------------------------------------- */
/* --- Details -------------------------------------------------------------- */
#include "crocoddyl/multibody/residuals/kinostate.hxx"
