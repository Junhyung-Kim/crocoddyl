...
struct IntegratedActionDataRKTpl : public IntegratedActionDataAbstractTpl<_Scalar> {
  ...
  explicit IntegratedActionDataRKTpl(Model<Scalar>* const model)
      : Base(model),
        ...
        y(model->get_ni(), VectorXs::Zero(model->get_state()->get_nx() + 8)),
        ws(model->get_ni(), VectorXs::Zero(model->get_control()->get_nw() + 4)),
        ...
        dki_du(model->get_ni(), MatrixXs::Zero(model->get_state()->get_ndx(), model->get_nu() + 4)),
        dyi_dx(model->get_ni(), MatrixXs::Zero(model->get_state()->get_ndx(), model->get_state()->get_ndx())),
        dyi_du(model->get_ni(), MatrixXs::Zero(model->get_state()->get_ndx(), model->get_nu() + 4)),
        dli_dx(model->get_ni(), VectorXs::Zero(model->get_state()->get_ndx())),
        dli_du(model->get_ni(), VectorXs::Zero(model->get_nu() + 4)),
        ddli_ddx(model->get_ni(), MatrixXs::Zero(model->get_state()->get_ndx(), model->get_state()->get_ndx())),
        ddli_ddw(model->get_ni(), MatrixXs::Zero(model->get_control()->get_nw(), model->get_control()->get_nw() + 4)),
        ddli_ddu(model->get_ni(), MatrixXs::Zero(model->get_nu() + 4, model->get_nu() + 4)),
        ddli_dxdw(model->get_ni(), MatrixXs::Zero(model->get_state()->get_ndx(), model->get_control()->get_nw() + 4)),
        ddli_dxdu(model->get_ni(), MatrixXs::Zero(model->get_state()->get_ndx(), model->get_nu() + 4)),
        ddli_dwdu(model->get_ni(), MatrixXs::Zero(model->get_control()->get_nw() + 4, model->get_nu() + 4)),
        Luu_partialx(model->get_ni(), MatrixXs::Zero(model->get_nu() + 4, model->get_nu() + 4)),
        Lxu_i(model->get_ni(), MatrixXs::Zero(model->get_state()->get_ndx(), model->get_nu() + 4)),
        Lxx_partialx(model->get_ni(), MatrixXs::Zero(model->get_state()->get_ndx(), model->get_state()->get_ndx())),
        Lxx_partialu(model->get_ni(), MatrixXs::Zero(model->get_state()->get_ndx(), model->get_nu() + 4)) {
    dx.setZero();
